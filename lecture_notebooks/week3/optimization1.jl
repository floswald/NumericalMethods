...
begin
	using Optim
	result = optimize(rosen₁, zeros(2), BFGS())
end
...
* Here is the definition of $f'$: forward difference, central difference, and backward difference:
...
optimize(rosen₁, g!, h!, zeros(2), Newton())
