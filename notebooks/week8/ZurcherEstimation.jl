...
# ╔═╡ 38aa4818-b037-44a9-a27a-3b27118d159e
using Pkg
...
# ╔═╡ 47af6108-4804-4f94-8795-c7832a4a396b
...
# ╔═╡ 1740e2b5-a561-419f-bff0-d3e97a2b3bc3
...
function dplots(n)
	...
	p1 = @df bh2 bar(:x, :mean_replaced, group=:bustype, title="avg replacement indicator", bar_position=:dodge, ylab="share replaced", xlab="miles", alpha=0.9, legend = :topleft, ylims = (0,1))
	p2 = @df bh2 groupedbar(:x, :nrow, group=:bustype, bar_position=:stack, xlab="mileage state", ylab="number of buses", title="mileage states by bus groups", bar_width=1,ylims = (0,400))
	plot(p1,p2)
end
...
manifest_format = "2.0"
project_hash = "33f4201644ed5483e4f7712d0232a6b4efbd75ac"
