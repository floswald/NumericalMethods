...
This notebook is closely based on the [intro notebook](https://julia.quantecon.org/getting_started_julia/julia_by_example.html) at QuantEcon.org. Thanks to them!
"""
...
begin
	...
	plot(generatedatax(100, square), label="x^2",legend = :topleft)
