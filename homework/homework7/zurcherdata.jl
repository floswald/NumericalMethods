...
> Notice that the file `buses.csv` needs to be in the same directory as this notebook! You can download the file from [here]([this folder](https://github.com/floswald/NumericalMethods/tree/master/homework/homework7)).
"
...
# use combine and filter together
...
# use the @df macro to make a bar plot
